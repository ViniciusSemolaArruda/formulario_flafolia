...
export namespace $Enums {
  export const SambaTime: {
  LESS_THAN_1_YEAR: 'LESS_THAN_1_YEAR',
  FROM_1_TO_3_YEARS: 'FROM_1_TO_3_YEARS',
  MORE_THAN_3_YEARS: 'MORE_THAN_3_YEARS'
};

export type SambaTime = (typeof SambaTime)[keyof typeof SambaTime]

}

export type SambaTime = $Enums.SambaTime

export const SambaTime: typeof $Enums.SambaTime
...
export namespace Prisma {
  ...
  */
  ...
  export type CandidateMinAggregateOutputType = {
    ...
    participatedDetails: string | null
    sambaTime: $Enums.SambaTime | null
    hasLiveBatteryExp: boolean | null
    availableNightsWeekend: boolean | null
    awarePresenceRequired: boolean | null
    photoFaceUrl: string | null
    photoBodyUrl: string | null
    isOver18: boolean | null
    availableAllRehearsals: boolean | null
    awareRepresentBlock: boolean | null
    acceptedRegulation: boolean | null
    authorizedImageUse: boolean | null
  }
  ...
  export type CandidateCountAggregateOutputType = {
    ...
    participatedDetails: number
    sambaTime: number
    hasLiveBatteryExp: number
    availableNightsWeekend: number
    awarePresenceRequired: number
    photoFaceUrl: number
    photoBodyUrl: number
    isOver18: number
    availableAllRehearsals: number
    awareRepresentBlock: number
    acceptedRegulation: number
    authorizedImageUse: number
    _all: number
  }
  ...
  export type CandidateMinAggregateInputType = {
    ...
    participatedDetails?: true
    sambaTime?: true
    hasLiveBatteryExp?: true
  ...
  export type CandidateSelect<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetSelect<{
    ...
    instagram?: boolean
    hasParticipatedBefore?: boolean
    participatedDetails?: boolean
    sambaTime?: boolean
    hasLiveBatteryExp?: boolean
    availableNightsWeekend?: boolean
    awarePresenceRequired?: boolean
    photoFaceUrl?: boolean
    photoBodyUrl?: boolean
    isOver18?: boolean
    availableAllRehearsals?: boolean
    awareRepresentBlock?: boolean
    acceptedRegulation?: boolean
  ...
  export type CandidateOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "createdAt" | "updatedAt" | "fullName" | "artisticName" | "birthDate" | "phoneWhatsapp" | "email" | "city" | "neighborhood" | "instagram" | "hasParticipatedBefore" | "participatedDetails" | "sambaTime" | "hasLiveBatteryExp" | "availableNightsWeekend" | "awarePresenceRequired" | "photoFaceUrl" | "photoBodyUrl" | "isOver18" | "availableAllRehearsals" | "awareRepresentBlock" | "acceptedRegulation" | "authorizedImageUse", ExtArgs["result"]["candidate"]>
  ...
  interface CandidateFieldRefs {
    ...
    readonly artisticName: FieldRef<"Candidate", 'String'>
    readonly birthDate: FieldRef<"Candidate", 'DateTime'>
    readonly phoneWhatsapp: FieldRef<"Candidate", 'String'>
    ...
    readonly instagram: FieldRef<"Candidate", 'String'>
    readonly hasParticipatedBefore: FieldRef<"Candidate", 'Boolean'>
    readonly participatedDetails: FieldRef<"Candidate", 'String'>
    readonly sambaTime: FieldRef<"Candidate", 'SambaTime'>
    readonly hasLiveBatteryExp: FieldRef<"Candidate", 'Boolean'>
    readonly availableNightsWeekend: FieldRef<"Candidate", 'Boolean'>
    readonly awarePresenceRequired: FieldRef<"Candidate", 'Boolean'>
    readonly photoFaceUrl: FieldRef<"Candidate", 'String'>
    readonly photoBodyUrl: FieldRef<"Candidate", 'String'>
    readonly isOver18: FieldRef<"Candidate", 'Boolean'>
    readonly availableAllRehearsals: FieldRef<"Candidate", 'Boolean'>
    readonly awareRepresentBlock: FieldRef<"Candidate", 'Boolean'>
    readonly acceptedRegulation: FieldRef<"Candidate", 'Boolean'>
    readonly authorizedImageUse: FieldRef<"Candidate", 'Boolean'>
  }
  ...
  /**
   * Reference to a field of type 'SambaTime'
   */
  export type EnumSambaTimeFieldRefInput<$PrismaModel> = FieldRefInputType<$PrismaModel, 'SambaTime'>
   ...
   * Reference to a field of type 'SambaTime[]'
   */
  export type ListEnumSambaTimeFieldRefInput<$PrismaModel> = FieldRefInputType<$PrismaModel, 'SambaTime[]'>
  ...
  export type CandidateWhereInput = {
    ...
    artisticName?: StringNullableFilter<"Candidate"> | string | null
    birthDate?: DateTimeFilter<"Candidate"> | Date | string
    phoneWhatsapp?: StringFilter<"Candidate"> | string
    email?: StringFilter<"Candidate"> | string
    city?: StringFilter<"Candidate"> | string
    neighborhood?: StringNullableFilter<"Candidate"> | string | null
    instagram?: StringNullableFilter<"Candidate"> | string | null
    hasParticipatedBefore?: BoolFilter<"Candidate"> | boolean
    participatedDetails?: StringNullableFilter<"Candidate"> | string | null
    sambaTime?: EnumSambaTimeFilter<"Candidate"> | $Enums.SambaTime
    hasLiveBatteryExp?: BoolFilter<"Candidate"> | boolean
    availableNightsWeekend?: BoolFilter<"Candidate"> | boolean
    awarePresenceRequired?: BoolFilter<"Candidate"> | boolean
    photoFaceUrl?: StringFilter<"Candidate"> | string
    photoBodyUrl?: StringFilter<"Candidate"> | string
    isOver18?: BoolFilter<"Candidate"> | boolean
    availableAllRehearsals?: BoolFilter<"Candidate"> | boolean
    awareRepresentBlock?: BoolFilter<"Candidate"> | boolean
    acceptedRegulation?: BoolFilter<"Candidate"> | boolean
    authorizedImageUse?: BoolFilter<"Candidate"> | boolean
  }
  ...
  export type CandidateOrderByWithRelationInput = {
    ...
    updatedAt?: SortOrder
    fullName?: SortOrder
    artisticName?: SortOrderInput | SortOrder
    birthDate?: SortOrder
    ...
    participatedDetails?: SortOrderInput | SortOrder
    sambaTime?: SortOrder
    hasLiveBatteryExp?: SortOrder
    availableNightsWeekend?: SortOrder
    awarePresenceRequired?: SortOrder
    photoFaceUrl?: SortOrder
    photoBodyUrl?: SortOrder
    isOver18?: SortOrder
    availableAllRehearsals?: SortOrder
    awareRepresentBlock?: SortOrder
    acceptedRegulation?: SortOrder
    authorizedImageUse?: SortOrder
  }
  ...
  export type CandidateScalarWhereWithAggregatesInput = {
    ...
    artisticName?: StringNullableWithAggregatesFilter<"Candidate"> | string | null
    birthDate?: DateTimeWithAggregatesFilter<"Candidate"> | Date | string
    phoneWhatsapp?: StringWithAggregatesFilter<"Candidate"> | string
    email?: StringWithAggregatesFilter<"Candidate"> | string
    city?: StringWithAggregatesFilter<"Candidate"> | string
    neighborhood?: StringNullableWithAggregatesFilter<"Candidate"> | string | null
    instagram?: StringNullableWithAggregatesFilter<"Candidate"> | string | null
    hasParticipatedBefore?: BoolWithAggregatesFilter<"Candidate"> | boolean
    participatedDetails?: StringNullableWithAggregatesFilter<"Candidate"> | string | null
    sambaTime?: EnumSambaTimeWithAggregatesFilter<"Candidate"> | $Enums.SambaTime
    hasLiveBatteryExp?: BoolWithAggregatesFilter<"Candidate"> | boolean
    availableNightsWeekend?: BoolWithAggregatesFilter<"Candidate"> | boolean
    awarePresenceRequired?: BoolWithAggregatesFilter<"Candidate"> | boolean
    photoFaceUrl?: StringWithAggregatesFilter<"Candidate"> | string
    photoBodyUrl?: StringWithAggregatesFilter<"Candidate"> | string
    isOver18?: BoolWithAggregatesFilter<"Candidate"> | boolean
    availableAllRehearsals?: BoolWithAggregatesFilter<"Candidate"> | boolean
    awareRepresentBlock?: BoolWithAggregatesFilter<"Candidate"> | boolean
    acceptedRegulation?: BoolWithAggregatesFilter<"Candidate"> | boolean
    authorizedImageUse?: BoolWithAggregatesFilter<"Candidate"> | boolean
  }
  ...
  export type CandidateUpdateInput = {
    ...
    artisticName?: NullableStringFieldUpdateOperationsInput | string | null
    ...
    hasParticipatedBefore?: BoolFieldUpdateOperationsInput | boolean
    participatedDetails?: NullableStringFieldUpdateOperationsInput | string | null
    sambaTime?: EnumSambaTimeFieldUpdateOperationsInput | $Enums.SambaTime
    hasLiveBatteryExp?: BoolFieldUpdateOperationsInput | boolean
    availableNightsWeekend?: BoolFieldUpdateOperationsInput | boolean
    awarePresenceRequired?: BoolFieldUpdateOperationsInput | boolean
    photoFaceUrl?: StringFieldUpdateOperationsInput | string
    photoBodyUrl?: StringFieldUpdateOperationsInput | string
    isOver18?: BoolFieldUpdateOperationsInput | boolean
    availableAllRehearsals?: BoolFieldUpdateOperationsInput | boolean
    awareRepresentBlock?: BoolFieldUpdateOperationsInput | boolean
    acceptedRegulation?: BoolFieldUpdateOperationsInput | boolean
    authorizedImageUse?: BoolFieldUpdateOperationsInput | boolean
  }
  ...
  export type EnumSambaTimeFilter<$PrismaModel = never> = {
    equals?: $Enums.SambaTime | EnumSambaTimeFieldRefInput<$PrismaModel>
    in?: $Enums.SambaTime[] | ListEnumSambaTimeFieldRefInput<$PrismaModel>
    notIn?: $Enums.SambaTime[] | ListEnumSambaTimeFieldRefInput<$PrismaModel>
    not?: NestedEnumSambaTimeFilter<$PrismaModel> | $Enums.SambaTime
  }
  ...
  export type EnumSambaTimeWithAggregatesFilter<$PrismaModel = never> = {
    equals?: $Enums.SambaTime | EnumSambaTimeFieldRefInput<$PrismaModel>
    in?: $Enums.SambaTime[] | ListEnumSambaTimeFieldRefInput<$PrismaModel>
    notIn?: $Enums.SambaTime[] | ListEnumSambaTimeFieldRefInput<$PrismaModel>
    not?: NestedEnumSambaTimeWithAggregatesFilter<$PrismaModel> | $Enums.SambaTime
    _count?: NestedIntFilter<$PrismaModel>
    _min?: NestedEnumSambaTimeFilter<$PrismaModel>
    _max?: NestedEnumSambaTimeFilter<$PrismaModel>
  }
  ...
  export type EnumSambaTimeFieldUpdateOperationsInput = {
    set?: $Enums.SambaTime
  }
  ...
  export type NestedEnumSambaTimeFilter<$PrismaModel = never> = {
    equals?: $Enums.SambaTime | EnumSambaTimeFieldRefInput<$PrismaModel>
    in?: $Enums.SambaTime[] | ListEnumSambaTimeFieldRefInput<$PrismaModel>
    notIn?: $Enums.SambaTime[] | ListEnumSambaTimeFieldRefInput<$PrismaModel>
    not?: NestedEnumSambaTimeFilter<$PrismaModel> | $Enums.SambaTime
  ...
  export type NestedEnumSambaTimeWithAggregatesFilter<$PrismaModel = never> = {
    equals?: $Enums.SambaTime | EnumSambaTimeFieldRefInput<$PrismaModel>
    in?: $Enums.SambaTime[] | ListEnumSambaTimeFieldRefInput<$PrismaModel>
    notIn?: $Enums.SambaTime[] | ListEnumSambaTimeFieldRefInput<$PrismaModel>
    not?: NestedEnumSambaTimeWithAggregatesFilter<$PrismaModel> | $Enums.SambaTime
